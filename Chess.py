...
while currentState != STATE.QUIT:
            ...
            if e.key == pygame.K_SPACE and currentState == STATE.GAME:
                if selectedPiece is not None:
                    ...
                    if org_piece.special()[0] == False:
                        # Exception
                        if org_piece.rank == 4:
                            org_piece.special([board, all_pieces])
                            selectedPiece = None
                            turnCounter += 1
                            continue
    ...
    rescaled_pawnW_img = pygame.transform.scale(pygame.image.load("assets/PawnW.png"), (20 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_knightW_img = pygame.transform.scale(pygame.image.load("assets/KnightW.png"), (20 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_bishopW_img = pygame.transform.scale(pygame.image.load("assets/BishopW.png"), (17 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_rookW_img = pygame.transform.scale(pygame.image.load("assets/RookW.png"), (20 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_queenW_img = pygame.transform.scale(pygame.image.load("assets/QueenW.png"), (17 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_kingW_img = pygame.transform.scale(pygame.image.load("assets/KingW.png"), (14 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    ...
    rescaled_pawnB_img = pygame.transform.scale(pygame.image.load("assets/PawnB.png"), (20 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_knightB_img = pygame.transform.scale(pygame.image.load("assets/KnightB.png"), (20 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_bishopB_img = pygame.transform.scale(pygame.image.load("assets/BishopB.png"), (17 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_rookB_img = pygame.transform.scale(pygame.image.load("assets/RookB.png"), (20 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_queenB_img = pygame.transform.scale(pygame.image.load("assets/QueenB.png"), (17 * ASPECT_RATIO, 20 * ASPECT_RATIO))
    rescaled_kingB_img = pygame.transform.scale(pygame.image.load("assets/KingB.png"), (14 * ASPECT_RATIO, 20 * ASPECT_RATIO))
